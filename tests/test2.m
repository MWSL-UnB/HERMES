...
SETTINGS.SCENARIO.NODE{3}.POSITION = [0 0 0]; %NOVO
...
SETTINGS.SCENARIO.NODE{3}.VELOCITY = 0; %NOVO
...
SETTINGS.SCENARIO.MODEM{3}.NODE = 3; %NOVO
...
SETTINGS.SCENARIO.MODEM{2}.TECHNOLOGY = SETTINGS.SCENARIO.MODEM{1}.TECHNOLOGY;
SETTINGS.SCENARIO.MODEM{3}.TECHNOLOGY = SETTINGS.SCENARIO.MODEM{1}.TECHNOLOGY; %NOVO
...
SETTINGS.SCENARIO.MODEM{3}.LTE = SETTINGS.SCENARIO.MODEM{1}.LTE; %NOVO
...
SETTINGS.SCENARIO.MODEM{ 3 }.NUMBER_OF_ANTENNAS = 1; %NOVO

SETTINGS.SCENARIO.MODEM{ 1 }.ANTENNA_POSITION = [0 0 0];
SETTINGS.SCENARIO.MODEM{ 2 }.ANTENNA_POSITION = [0 0 0];
SETTINGS.SCENARIO.MODEM{ 3 }.ANTENNA_POSITION = [0 0 0]; %NOVO
...
SETTINGS.SCENARIO.MODEM{ 3 }.ANTENNA_TYPE = enum.antenna.AntennaType.ISOTROPIC; %NOVO
...
SETTINGS.SCENARIO.CARRIERS_DISTANCE =149000000;
%GUARDBAND = 0 ;
...
SETTINGS.SCENARIO.MODEM{3}.CARRIER_FREQUENCY = SETTINGS.SCENARIO.MODEM{1}.CARRIER_FREQUENCY + SETTINGS.SCENARIO.CARRIERS_DISTANCE; %NOVO
%SETTINGS.SCENARIO.MODEM{3}.CARRIER_FREQUENCY = SETTINGS.SCENARIO.MODEM{1}.CARRIER_FREQUENCY + 50e6 + 1*99e6; %NOVO
clear GUARDBAND;
